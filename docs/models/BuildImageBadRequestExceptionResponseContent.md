# openapi_client.model.build_image_bad_request_exception_response_content.BuildImageBadRequestExceptionResponseContent
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | This exception is thrown when a client calls the BuildImage API with an invalid request. This includes an error due to invalid image configuration. | 
