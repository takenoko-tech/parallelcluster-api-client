# openapi_client.model.create_cluster_bad_request_exception_response_content.CreateClusterBadRequestExceptionResponseContent
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | This exception is thrown when a client calls the CreateCluster API with an invalid request. This includes an error due to invalid cluster configuration. | 
