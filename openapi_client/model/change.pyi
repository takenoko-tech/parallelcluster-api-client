...
class Change(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["parameter", "currentValue", "requestedValue", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["parameter", "currentValue", "requestedValue", ], str]):
