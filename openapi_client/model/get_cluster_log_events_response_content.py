...
class GetClusterLogEventsResponseContent(
    schemas.DictSchema
):
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["prevToken"]) -> MetaOapg.properties.prevToken: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["nextToken", "prevToken", "events", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["prevToken"]) -> typing.Union[MetaOapg.properties.prevToken, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["nextToken", "prevToken", "events", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        prevToken: typing.Union[MetaOapg.properties.prevToken, str, schemas.Unset] = schemas.unset,
