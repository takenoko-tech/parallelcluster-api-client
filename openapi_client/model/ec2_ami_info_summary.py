...
class Ec2AmiInfoSummary(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["amiId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["amiId", ], str]):
