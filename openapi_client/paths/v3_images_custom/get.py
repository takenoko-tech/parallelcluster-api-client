...
ImageStatusSchema = ImageStatusFilteringOption
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'imageStatus': typing.Union[ImageStatusSchema, ],
    }
)
...
request_query_image_status = api_client.QueryParameter(
    name="imageStatus",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = ListImagesResponseContent
