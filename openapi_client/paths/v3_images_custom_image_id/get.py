...
SchemaFor200ResponseBodyApplicationJson = DescribeImageResponseContent
...
class DescribeImage(BaseApi):
    ...
    def describe_image(
        ...
        return self._describe_image_oapg(
