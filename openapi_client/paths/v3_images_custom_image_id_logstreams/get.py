...
SchemaFor200ResponseBodyApplicationJson = ListImageLogStreamsResponseContent
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_image_log_streams_oapg(
        self,
...
class ListImageLogStreams(BaseApi):
    ...
    def list_image_log_streams(
        ...
        return self._list_image_log_streams_oapg(
