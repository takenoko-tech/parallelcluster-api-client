...
QueueNameSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'nodeType': typing.Union[NodeTypeSchema, ],
        'queueName': typing.Union[QueueNameSchema, str, ],
    },
    total=False
)
...
request_query_queue_name = api_client.QueryParameter(
    name="queueName",
    style=api_client.ParameterStyle.FORM,
    schema=QueueNameSchema,
    explode=True,
)
# Path params
...
SchemaFor200ResponseBodyApplicationJson = DescribeClusterInstancesResponseContent
...
class BaseApi(api_client.Api):
    @typing.overload
    def _describe_cluster_instances_oapg(
        self,
...
class DescribeClusterInstances(BaseApi):
    ...
    def describe_cluster_instances(
        ...
        return self._describe_cluster_instances_oapg(
