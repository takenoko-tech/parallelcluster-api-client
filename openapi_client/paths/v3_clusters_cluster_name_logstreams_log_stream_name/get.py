...
StartFromHeadSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'startFromHead': typing.Union[StartFromHeadSchema, bool, ],
...
request_query_start_from_head = api_client.QueryParameter(
    name="startFromHead",
    style=api_client.ParameterStyle.FORM,
    schema=StartFromHeadSchema,
    explode=True,
)
...
LogStreamNameSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'clusterName': typing.Union[ClusterNameSchema, str, ],
        'logStreamName': typing.Union[LogStreamNameSchema, str, ],
    }
)
...
request_path_log_stream_name = api_client.PathParameter(
    name="logStreamName",
    style=api_client.ParameterStyle.SIMPLE,
    schema=LogStreamNameSchema,
    required=True,
)
_auth = [
    'aws.auth.sigv4',
]
SchemaFor200ResponseBodyApplicationJson = GetClusterLogEventsResponseContent
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_cluster_log_events_oapg(
        self,
...
class GetClusterLogEvents(BaseApi):
    ...
    def get_cluster_log_events(
        ...
        return self._get_cluster_log_events_oapg(
