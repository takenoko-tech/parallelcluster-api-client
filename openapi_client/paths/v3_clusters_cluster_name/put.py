...
ForceUpdateSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'forceUpdate': typing.Union[ForceUpdateSchema, bool, ],
    },
    total=False
)
...
# body param
SchemaForRequestBodyApplicationJson = UpdateClusterRequestContent


request_body_update_cluster_request_content = api_client.RequestBody(
    content={
...
SchemaFor202ResponseBodyApplicationJson = UpdateClusterResponseContent
...
SchemaFor400ResponseBodyApplicationJson = UpdateClusterBadRequestExceptionResponseContent
...
class BaseApi(api_client.Api):
    ...
    def _update_cluster_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_update_cluster_request_content.serialize(body, content_type)
