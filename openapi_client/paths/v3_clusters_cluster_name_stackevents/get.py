...
SchemaFor200ResponseBodyApplicationJson = GetClusterStackEventsResponseContent
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_cluster_stack_events_oapg(
        self,
...
class GetClusterStackEvents(BaseApi):
    ...
    def get_cluster_stack_events(
        ...
        return self._get_cluster_stack_events_oapg(
