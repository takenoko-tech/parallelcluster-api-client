...
SchemaFor200ResponseBodyApplicationJson = DescribeComputeFleetResponseContent
...
class BaseApi(api_client.Api):
    @typing.overload
    def _describe_compute_fleet_oapg(
        self,
...
class DescribeComputeFleet(BaseApi):
    ...
    def describe_compute_fleet(
        ...
        return self._describe_compute_fleet_oapg(
