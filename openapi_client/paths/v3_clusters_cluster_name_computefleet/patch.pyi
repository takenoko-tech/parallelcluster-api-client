...
# body param
SchemaForRequestBodyApplicationJson = UpdateComputeFleetRequestContent


request_body_update_compute_fleet_request_content = api_client.RequestBody(
    content={
...
SchemaFor204ResponseBodyApplicationJson = UpdateComputeFleetResponseContent
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_compute_fleet_oapg(
        self,
    ...
    def _update_compute_fleet_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_update_compute_fleet_request_content.serialize(body, content_type)
...
class UpdateComputeFleet(BaseApi):
    ...
    def update_compute_fleet(
        ...
        return self._update_compute_fleet_oapg(
            body=body,
