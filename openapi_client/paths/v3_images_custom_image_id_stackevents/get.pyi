...
SchemaFor200ResponseBodyApplicationJson = GetImageStackEventsResponseContent
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_image_stack_events_oapg(
        self,
...
class GetImageStackEvents(BaseApi):
    ...
    def get_image_stack_events(
        ...
        return self._get_image_stack_events_oapg(
