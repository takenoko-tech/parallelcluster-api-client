...
SchemaFor200ResponseBodyApplicationJson = ListOfficialImagesResponseContent
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_official_images_oapg(
        self,
...
class ListOfficialImages(BaseApi):
    ...
    def list_official_images(
        ...
        return self._list_official_images_oapg(
