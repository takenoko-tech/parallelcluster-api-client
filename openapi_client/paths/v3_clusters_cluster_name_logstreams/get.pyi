...
SchemaFor200ResponseBodyApplicationJson = ListClusterLogStreamsResponseContent
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_cluster_log_streams_oapg(
        self,
...
class ListClusterLogStreams(BaseApi):
    ...
    def list_cluster_log_streams(
        ...
        return self._list_cluster_log_streams_oapg(
