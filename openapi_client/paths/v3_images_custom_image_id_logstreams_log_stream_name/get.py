...
SchemaFor200ResponseBodyApplicationJson = GetImageLogEventsResponseContent
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_image_log_events_oapg(
        self,
...
class GetImageLogEvents(BaseApi):
    ...
    def get_image_log_events(
        ...
        return self._get_image_log_events_oapg(
